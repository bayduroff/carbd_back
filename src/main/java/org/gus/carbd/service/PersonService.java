...
public class PersonService {
    ...
    public void editPersonById(int id, Person changedPerson) {
        ...
        if (changedPerson.getName() != null) {  //проверка на длину строки?
        ...
        if (changedPerson.getVehicles() != null) {             //мб убрать
    ...
    public void assignVehicleToPerson(int id, int vin) {
        Person person = personRepository.findById(id).get(); //orElseThrow(ex)
